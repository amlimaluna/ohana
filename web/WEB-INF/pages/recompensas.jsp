<%-- 
    ...
    Created on : 12/05/2019, 20:36:46
    Author     : amaaa
--%>
	...
	<body class="gray">
		...
		<button class="btn rounded-circle p-3 bg-blue b-shadow" ><a href="doacoes.jsp" class="text-light">Doar</a></button>
		  ...
		  <div class="card-header bg-warning">
		    <h5 class="text-dark text-center">Benefícios</h5>
		  </div>
		  <ul class="list-group list-group-flush">
		    ...
		    <li class="list-group-item bg-blue text-center"><a href="" class="text-light">Resgatar</a></li>
		  </ul>
		</div>
		<br>
		<br>
