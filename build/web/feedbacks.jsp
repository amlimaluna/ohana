<%-- 
    Document   : feedbacks
    Created on : 12/05/2019, 20:27:06
    Author     : amaaa
--%>
		...
		<div class="mx-md-auto p-0 m-0 col-md-6">
			<div class="card">
			  <div class="card-header bg-warning">
			    <h5 class="text-dark text-center">Feedbacks</h5>
			  </div>
			  <ul class="list-group list-group-flush">
			    <li class="list-group-item">
			    	<div class="card-body d-block m-0 p-0">
			    		<img class="float-left wds rounded mr-3" src="images/fotos/Animais/Feedback/1.jpg">
					    <a href="feedbacksaolazaro.jsp"><h5 class="card-title">Arrecadação São Lázaro</h5></a>
					    <p class="card-text">Conseguimos alcançar nossa meta dessa mês!</p>
					</div>
			    </li>
			    <li class="list-group-item">
			    	<div class="card-body d-block m-0 p-0">
			    		<img class="float-left wds rounded mr-3" src="images/fotos/Idosos/Feedback/1.jpg">
					    <a href="feedbacksaolazaro.jsp"><h5 class="card-title">Arrecadação Três Irmãs</h5></a>
					    <p class="card-text">Conseguimos alcançar nossa meta dessa mês!</p>
					</div>
			    </li>
			    <li class="list-group-item">
			    	<div class="card-body d-block m-0 p-0">
			    		<img class="float-left wds rounded mr-3" src="images/fotos/Crianças/Feedback/1.jpg">
					    <a href="feedbacksaolazaro.jsp"><h5 class="card-title">Arrecadação das Crianças</h5></a>
					    <p class="card-text">Conseguimos alcançar nossa meta dessa mês!</p>
					</div>
			    </li>
			    <li class="list-group-item">
			    	<div class="card-body d-block m-0 p-0">
			    		<img class="float-left wds rounded mr-3" src="images/fotos/Animais/Doações/1.jpg">
					    <a href="feedbacksaolazaro.jsp"><h5 class="card-title">Arrecadação São Lázaro</h5></a>
					    <p class="card-text">Conseguimos alcançar nossa meta dessa mês!</p>
					</div>
			    </li>
